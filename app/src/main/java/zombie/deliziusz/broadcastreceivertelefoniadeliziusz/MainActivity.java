package zombie.deliziusz.broadcastreceivertelefoniadeliziusz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //zombie.deliziusz.broadcastreceivertelefoniadeliziusz.MIBROACAST
                //broadcast.setAction("zombie.deliziusz.broadcastreceivertelefoniadeliziusz.MIBROACAST");
                broadcast.setAction("zombie.deliziusz.broadcastreceivertelefoniadeliziusz.MIBROACAST");
